...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 The follow-up audit note continues to record the configured local calendar date
- [ ] #2 The test compares sent_at in the configured timezone rather than its raw UTC date
- [ ] #3 The focused regression and full CI pass across the UTC/local-date boundary
<!-- AC:END -->
