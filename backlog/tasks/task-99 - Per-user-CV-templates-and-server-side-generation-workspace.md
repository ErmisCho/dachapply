...
id: TASK-99
title: >-
  Per-user CV templates and a server-side generation workspace (SPLIT - see
  TASK-99a / TASK-99b)
status: Done
assignee: []
...
Also corrected: the four code citations in the description had drifted (TASK-204 (formerly duplicate TASK-111) inserted
